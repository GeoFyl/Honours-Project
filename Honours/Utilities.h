...
public :
	...
	static void AllocateDefaultBuffer(ID3D12Device* device, UINT64 buffer_size, ID3D12Resource** buffer, D3D12_RESOURCE_STATES initial_state = D3D12_RESOURCE_STATE_GENERIC_READ, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE);
